...
console.log("CONNECTING humbah-md 🧬...");
...
console.log('humbah-md CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ humbah-md ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ mtee ✅*
...
//================ownerreact==============
if(senderNumber.includes("263xxxxxxxxx")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("263789677639")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("2637789677639")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, humbah-md STARTED ✅");
});
